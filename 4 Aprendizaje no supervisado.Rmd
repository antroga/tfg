...
Represento graficamente las comunidades descubiertas en usando la forma de matriz de distancias para poder comparar los resultados.
```{r}
set.seed(55)
...
plot(matgraf, col= cfg$membership, main="Optimizacion de la modularidad, k=3")
```