...
En el ámbito del analisis de redes biologicas, el descubrimiento de comunidades permite agrupar los nodos aludiendo a funcionalidad comun o alto grado de relación.
...
Primero creo un vector con numeros aleatorios que sirve para inicializar el algoritmo (si no, en cada ejecución dará resultados diferentes).
```{r}
set.seed(55)
...
Las comunidades y el número de nodos que tiene cada una.
...
```
Guardo el listado de miembros en un archivo txt que será usado posteriormente.
```{r}
